...
import '../../data/services/audio_service.dart'
    show audioHandler, PlaybackContext, AudioServiceHandler;
...
class _FullPlayerState extends ConsumerState<FullPlayer> {
  ...
  void _startBeatTimer() {
    _beatTimer = Timer.periodic(const Duration(milliseconds: 40), (_) {
      ...
      if (isPlaying) {
        ...
        final beatSim =
            (sin(time * 24.0).abs() * 0.5) + (sin(time * 48.0).abs() * 0.2);
  ...
  Widget build(BuildContext context) {
    ...
    final specs = ref.watch(audioSpecsProvider).valueOrNull ??
        BitPerfectService().currentSpecs;
                          ...
                          children: [
                            ...
                            ValueListenableBuilder(
                              ...
                              builder: (context, Box box, _) {
                                final isDownloaded =
                                    box.containsKey(widget.currentSong.id);
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                GestureDetector(
                                  onTap: () =>
                                      _showBitPerfectModal(context, ref, specs),
                                  child: Container(
                                    padding: const EdgeInsets.symmetric(
                                                ...
                                                children: [
                                                  ...
                                                  _detailRow(
                                                      ...
                                                      _formatDuration(widget
                                                          .currentSong
                                                          .duration)),
                                                  _detailRow('Audio Codec',
                                                      'MP3 (MPEG-1 Audio Layer III)'),
                                                  _detailRow('Bitrate',
                                                      '320 kbps (High Quality)'),
                                                  _detailRow('Sample Rate',
                                                      '44.1 kHz'),
                                                  _detailRow('Channels',
                                                      'Stereo (2.0)'),
                                                  _detailRow(
                                                  ...
                                                  Builder(
                                                    builder: (context) {
                                                      ...
                                                      final double estSizeMb =
                                                          (durationSec * 320) /
                                                              (8 * 1024);
                                                      final String estSizeStr =
                                                          durationSec > 0
                                                              ? '${estSizeMb.toStringAsFixed(2)} MB'
                                                              : 'Unknown';
                                                      return _detailRow(
                                                          'Est. Size',
                                                          estSizeStr);
                                              ...
                                              children: [
                                                ...
                                                Expanded(
                                                  child: Consumer(
                                                    builder:
                                                        (context, ref, child) {
                                                      final lyricsAsync = ref
                                                          .watch(lyricsProvider(
                                                              widget
                                                                  .currentSong));
                          ...
                          Consumer(
                            builder: (context, ref, child) {
                              ...
                              final relatedSongsAsync = ref.watch(
                                  multipleArtistsTopTracksProvider(
                                      joinedArtistsKey));
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    focusedBorder: UnderlineInputBorder(
                                      borderSide:
                                          BorderSide(color: AppColors.neonPink),
                                    ),
                                  ),
                                ),
                              ),
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  final minutes = int.tryParse(
                                      customTimerController.text.trim());
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              leading:
                  Icon(Icons.palette_rounded, color: AppColors.textPrimary),
              title: Text(
                'App Theme & Colors',
                style: TextStyle(color: AppColors.textPrimary),
              ),
  ...
  void _showAudioSettingsDialog(
      BuildContext context, AudioServiceHandler audioService) {
    showModalBottomSheet(
        context: context,
        backgroundColor: AppColors.deepSpaceBlackLight,
        shape: const RoundedRectangleBorder(
                      ...
                      children: [
                                ...
                                Padding(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color:
                                            (audioService.bassGain - profile.$2)
                                                            .abs() <
                                                        0.05 &&
                                                    (audioService.trebleGain -
                                                                profile.$3)
                                                            .abs() <
                                                        0.05
                                                ? AppColors.neonPink
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          color: (audioService.bassGain -
                                              ...
                                              : AppColors.textPrimary,
                                          fontSize: 11,
                                          fontWeight: (audioService.bassGain -
                                                              profile.$2)
                                                          .abs() <
                                                      0.05 &&
                                                  (audioService.trebleGain -
                          ...
                          children: [
                            Text('BASS BOOST',
                                style: TextStyle(
                                    ...
                                    fontWeight: FontWeight.bold,
                                    letterSpacing: 1.2)),
                            Text('${(audioService.bassGain * 100).toInt()}%',
                                style: TextStyle(
                                    color: AppColors.neonPink,
                                    fontSize: 12,
                                    fontWeight: FontWeight.bold)),
                            ...
                            for (final preset in [
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: (audioService.bassGain - preset.$2)
                                                .abs() <
                                            0.05
                                        ? AppColors.neonPink
                                            .withValues(alpha: 0.25)
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      fontSize: 11,
                                      fontWeight:
                                          (audioService.bassGain - preset.$2)
                                                      .abs() <
                                                  0.05
                                              ? FontWeight.bold
                                              : FontWeight.normal,
                        ...
                        SliderTheme(
                          data: SliderThemeData(
                            ...
                            overlayShape: const RoundSliderOverlayShape(
                                overlayRadius: 14),
                            activeTrackColor: audioService.bassGain > 0
                                ? AppColors.neonPink
                                : AppColors.divider,
                            inactiveTrackColor: AppColors.divider,
                            thumbColor: audioService.bassGain > 0
                                ? AppColors.neonPink
                                : AppColors.textSecondary,
                          ),
                          child: Slider(
                          ...
                          children: [
                            Text('TREBLE CLARITY',
                                style: TextStyle(
                                    ...
                                    fontWeight: FontWeight.bold,
                                    letterSpacing: 1.2)),
                            Text('${(audioService.trebleGain * 100).toInt()}%',
                                style: TextStyle(
                                    color: AppColors.neonCyan,
                                    fontSize: 12,
                                    fontWeight: FontWeight.bold)),
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  padding: const EdgeInsets.symmetric(
                                      horizontal: 12, vertical: 5),
                                  decoration: BoxDecoration(
                                    color: (audioService.trebleGain - preset.$2)
                                                .abs() <
                                            0.05
                                        ? AppColors.neonCyan
                                            .withValues(alpha: 0.25)
                                    ...
                                    border: Border.all(
                                      color:
                                          (audioService.trebleGain - preset.$2)
                                                      .abs() <
                                                  0.05
                                              ? AppColors.neonCyan
                                              : AppColors.divider,
                        ...
                        SliderTheme(
                          data: SliderThemeData(
                            ...
                            overlayShape: const RoundSliderOverlayShape(
                                overlayRadius: 14),
                            activeTrackColor: audioService.trebleGain > 0
                                ? AppColors.neonCyan
                                : AppColors.divider,
                            inactiveTrackColor: AppColors.divider,
                            thumbColor: audioService.trebleGain > 0
                                ? AppColors.neonCyan
                                : AppColors.textSecondary,
                          ),
                          child: Slider(
                            ...
                            Container(
                              ...
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton<double>(
                                  ...
                                  items: const [
                                    DropdownMenuItem(
                                        value: 2.0, child: Text('MAX 200%')),
                                    DropdownMenuItem(
                                        value: 3.0, child: Text('MAX 300%')),
                                    DropdownMenuItem(
                                        value: 4.0, child: Text('MAX 400%')),
                                  ],
                                  onChanged: (val) {
                                    if (val != null) {
  ...
  void _showBitPerfectModal(
      BuildContext context, WidgetRef ref, AudioHardwareSpecs specs) {
    var isUpdatingBitPerfect = false;
    showModalBottomSheet(
      context: context,
      ...
      builder: (ctx) {
        return StatefulBuilder(
          builder: (modalContext, setModalState) {
            final liveSpecs = ref.watch(audioSpecsProvider).valueOrNull ??
                BitPerfectService().currentSpecs;
            return Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    if (!liveSpecs.isSupported)
                      Padding(
                        padding: const EdgeInsets.only(top: 8),
                        child: Text(
                          'Bit-Perfect routing is unavailable for this audio output.',
                          style: TextStyle(
                            color: AppColors.textSecondary,
                            fontSize: 11,
                          ),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          _specRow('Sample Rate', liveSpecs.sampleRateDisplay,
                              isHighlight: true),
                          ...
                          const Divider(color: Colors.white10, height: 18),
                          _specRow(
                              'Active Output Device', liveSpecs.activeDevice),
                          const Divider(color: Colors.white10, height: 18),
                          _specRow(
                            'Bypass Software Mixer (SRC)',
                            liveSpecs.isBitPerfectActive
                                ? 'Bypassed (HAL Direct)'
                                : 'Standard Android Mixer',
  ...
  Widget _specRow(String label, String value,
      {bool isHighlight = false, bool? isPositive}) {
