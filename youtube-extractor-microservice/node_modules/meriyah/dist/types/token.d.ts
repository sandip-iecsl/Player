export declare const enum Token {
    ...
    AsyncKeyword = 209005,
    AwaitKeyword = 209006,
    ConstructorKeyword = 209007,
    GetKeyword = 209008,
    SetKeyword = 209009,
    AccessorKeyword = 209010,
    FromKeyword = 209011,
    OfKeyword = 471156,
    UsingKeyword = 209013,
    EnumKeyword = 86134,
    Eval = 537079927,
    Arguments = 537079928,
    EscapedReserved = -2147483527,
    EscapedFutureReserved = -2147483526,
    AnyIdentifier = 209019,
...
export declare const descKeywordTable: Map<string, Token>;
export declare const minKeywordLength: number;
export declare const maxKeywordLength: number;
